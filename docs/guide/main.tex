...
\begin{figure}[b] 
  \begin{center}
    ...
    \caption{NCBI Home Page\label{fig:ncbihome}}
  \end{center}
\end{figure}
...
\begin{figure}[b]
  \begin{center}
    ...
    \caption{Search Results\label{fig:ncbisearchresults}}
  \end{center}
\end{figure}
...
Simply paste (using Ctrl-V or using the EditPaste menu) the sequence
...
\begin{figure}[b]
  \begin{center}
    ...
    \caption{Target Area Selection Example}
    \label{fig:pdareaselection}
  \end{center}
\end{figure}
