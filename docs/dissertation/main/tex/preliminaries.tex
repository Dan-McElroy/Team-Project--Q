There are some terms that will be used later in the report that should be 
...
It should be noted that many of these rules are not precise, and do not involve 
