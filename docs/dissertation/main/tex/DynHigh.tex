...
Ultimately, the final implementation of this feature can be split into
two main components:
...
to update forward primer highlights and \texttt{searchC()} to update
reverse primer primer highlights.
...
determined by the following if statement:
